...
//    private StockService stockService;
    ...
    */
    ...
    void 동시에_100개의_주문_요청() throws InterruptedException {
        ...
        // 비동기로 실행하는 작업을 간단하게 실행할 수 있게 도와주는 ExecutorService
        ExecutorService executorService = Executors.newFixedThreadPool(32);

        // 다른 스레드에서 특정 작업이 완료될 때 까지 대기하도록 도와주는 동기화 도구
        ...
        // 재고 확인을 위한 로직을 밑에다가 쓸 건데, 카운트가 0이 될 때까지 다음 코드를 실행하지 않게 해 줌.
        latch.await();
